<div>
    <div style="overscroll-behavior: none;">
        <div class="fixed w-full bg-gray-400 h-16 pt-2 text-white flex justify-between shadow-md"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="icon-dots-vertical w-8 h-8 mt-2 mr-2">
                <path class="text-gray-100 fill-current" fill-rule="evenodd"
                ...
                @else
                    <div class="clearfix w-4/4">
                        <div class="text-right">
                            <p class="bg-gray-300 mx-4 my-2 p-2 rounded-lg inline-block">{{ $message['message'] }} <b>:
                                    You</b></p>
                        </div>
                    </div>
                @endif
