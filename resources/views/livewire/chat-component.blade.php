<div>
    <div style="overscroll-behavior: none;">
          <div
            class="fixed w-full bg-gray-400 h-16 pt-2 text-white flex justify-between shadow-md"
          ...
          <div class="mt-20 mb-16">
            ...
            <div class="clearfix w-4/4">
                <div class="text-right">
                    <p class="bg-gray-300 mx-4 my-2 p-2 rounded-lg inline-block">{{ $message['message'] }} <b>: You</b></p>
                </div>
            </div>
            @endif
        ...
        <form wire:submit="sendMessage()">
            ...
            <button class="m-2" type="submit" style="outline: none;">
                <svg
                class="svg-inline--fa text-gray-100 fa-paper-plane fa-w-16 w-12 h-12 py-2 mr-2"
                aria-hidden="true"
                focusable="false"
                data-prefix="fas"
